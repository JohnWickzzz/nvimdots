...
local core_map = {
	...
	["n|<A-i>"] = map_cr("vertical resize +3"):with_silent():with_desc("window: Resize +3 vertically"),
	["n|<A-o>"] = map_cr("resize -3"):with_silent():with_desc("window: Resize -3 horizontally"),
